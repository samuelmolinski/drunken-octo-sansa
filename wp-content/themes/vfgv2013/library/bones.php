...
function bones_queue_high_js_and_css() {
  if (!is_admin()) {
    ...
    wp_register_script( 'jscrollpane', get_template_directory_uri() . '/library/js/jquery.jscrollpane.min.js', array( 'jquery' ));
    wp_enqueue_script( 'jscrollpane' );
    wp_register_script( 'mousewheel', get_template_directory_uri() . '/library/js/jquery.mousewheel.js');
    wp_enqueue_script( 'mousewheel' );
    wp_register_script( 'mwheelIntent', get_template_directory_uri() . '/library/js/mwheelIntent.js');
