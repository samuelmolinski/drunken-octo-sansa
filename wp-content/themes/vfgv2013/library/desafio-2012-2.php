...
function desafio_2012_2() { 
	// creating (registering) the custom type 
	register_post_type( 'desafio_2012-2', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
	 	// let's now add all the options for this post type
		array('labels' => array(
			'name' => __('Desafio 2012-2', 'post type general name'), /* This is the Title of the Group */
			'singular_name' => __('Desafio 2012-2', 'post type singular name'), /* This is the individual type */
			...
			'description' => __( 'Novo desafios do 2012-2' ), /* Custom Type Description */
			'public' => true,
	...
	add_action( 'init', 'desafio_2012_2');
