...
<?php
    ...
    if ($queryObject->have_posts()) {
        while ($queryObject->have_posts()) {
			...
			$img = get_crop_image($imgsrc, '&amp;w=164&amp;h=99&amp;zc=1');
			...
			if ($meta['status']== 'active') {
				$img = get_crop_image($imgsrc, '&amp;w=145&amp;h=90&amp;zc=1', '', get_the_title());
			} else {
				$imgsrc = desaturateImg($imgsrc);
				$img = get_crop_image($imgsrc, '&amp;w=145&amp;h=90&amp;zc=1', 'c', get_the_title());
			}
