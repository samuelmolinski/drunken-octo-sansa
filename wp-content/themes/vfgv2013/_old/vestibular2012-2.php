<?php
    if(NULL != $_GET['title']) {
    	$title = 'Vestibular FGV 2012.2 | '. trim($_GET['title']);
    } else {
    	$title = 'Vestibular FGV 2012.2 | ';
    }
    ...
    if(NULL != $_GET['forwardURL']) {
    	...
    	$forwardURL = 'https://vestibularfgv.com.br/2012-2/';
    }
    if(NULL != $_GET['page']) {
    	$page = 'page='.$_GET['page'];
    } else {
...
<meta property="fb:app_id" content="127828760677303">
